    ...
    <div class="row p-4 pb-0 pe-lg-0 align-items-center rounded-3">
      <div class="col-md p-3">
        ...
        <p class="lead text-end">General Science provides a comprehensive undergraduate science education with the
          opportunity for
          concentration in two or three of the following subject areas: Chemistry, Earth & Environmental Sciences, Life
          Science,
          Mathematical Sciences, and Physics.</p>
      </div>
      <div class="col-6 offset-lg-1 p-0 m-0" id="illustration">
        <script>
          var animation = bodymovin.loadAnimation({
            container: document.getElementById('illustration'),
            path: './assets/lottie/science.json',
            render: 'svg',
            loop: true,
            autoplay: true,
          });
