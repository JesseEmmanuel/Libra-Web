  ...
  <div class="container my-5">
    <div class="row pb-0 pe-lg-0 align-items-center rounded-3">
      <div class="col-md p-3 p-lg-5">
        <h1 class="display-4 fw-bold lh-1 text-end text-success">Social Science </h1>
        <p class="lead text-end">Social science is, in its broadest sense, the study of society and the manner in which
      ...
      <div class="col-6 offset-lg-1 p-0 m-0" id="illustration">
        <script>
          var animation = bodymovin.loadAnimation({
            ...
            path: './assets/lottie/social.json',
            render: 'svg',
            loop: true,
            autoplay: true,
          });
