  ...
  <div class="container my-5">
    <div class="row pb-0 pe-lg-0 align-items-center rounded-3">
      <div class="col-md p-3 p-lg-5">
        <h1 class="display-4 fw-bold lh-1 text-end text-success">Technology </h1>
        <p class="lead text-end">Technology is the application of scientific knowledge to the practical aims of human
          life or, as it is sometimes
          phrased, to the change and manipulation of the human environment.</p>
      </div>
      <div class="col-6 offset-lg-1 p-0 m-0" id="illustration">
        <script>
          var animation = bodymovin.loadAnimation({
            container: document.getElementById('illustration'),
            path: './assets/lottie/technology.json',
            render: 'svg',
            loop: true,
            autoplay: true,
          });
