...
<section>
  <div class="container my-5">
    <div class="row pb-0 pe-lg-0 align-items-center rounded-3">
      <div class="col-md">
        <h1 class="display-4 fw-bold lh-1 text-end text-success">Theology </h1>
        <p class="lead text-end">Theology is the systematic study of the nature of the divine and, more broadly, of
          religious belief.
          It is taught as an academic discipline, typically in universities and seminaries</p>
      </div>
      <div class="col-6 offset-lg-1 p-0 m-0" id="illustration">
        <script>
          var animation = bodymovin.loadAnimation({
            container: document.getElementById('illustration'),
            path: './assets/lottie/theology.json',
            render: 'svg',
            loop: true,
            autoplay: true,
          });
